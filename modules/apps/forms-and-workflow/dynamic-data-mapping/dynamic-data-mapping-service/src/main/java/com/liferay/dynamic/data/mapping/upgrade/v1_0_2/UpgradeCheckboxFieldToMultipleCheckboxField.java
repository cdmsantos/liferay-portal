...
package com.liferay.dynamic.data.mapping.upgrade.v1_0_2;
 ...
 */
public class UpgradeCheckboxFieldToMultipleCheckboxField
	extends UpgradeProcess {

	public UpgradeCheckboxFieldToMultipleCheckboxField(
	...
	protected JSONObject getPredefinedValue(
		...
		Iterator<String> keys = oldPredefinedValueJSONObject.keys();

		while (keys.hasNext()) {
			String key = keys.next();
			String value = oldPredefinedValueJSONObject.getString(key);
			...
			newPredefinedValueJSONObject.put(key, value);
		}
